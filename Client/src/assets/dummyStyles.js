export const adminContactsStyles = {
  ...
  contactItem: (index, total) =>
    `p-5 sm:p-8 bg-white transition-all duration-300 ease-in-out border-b ${index !== total - 1 ? "border-[#f1f5f9]" : "border-transparent"}`,
  contactHeader:
    "flex flex-col sm:flex-row justify-between items-start mb-6 gap-4 sm:gap-0",
  avatarWrapper: (role) =>
    `w-14 h-14 rounded-full flex items-center justify-center font-bold text-[1.25rem] shrink-0 ${role === "seller" ? "bg-[#dcfce7] text-[#166534]" : "bg-[#dbeafe] text-[#1e40af]"}`,
  nameBadgeContainer: "flex items-center gap-3 mb-1 flex-wrap",
  name: "text-[1.1rem] font-extrabold text-text-main",
  roleBadge: (role) =>
    `text-[0.7rem] px-[0.6rem] py-[0.2rem] rounded-full font-bold uppercase ${role === "seller" ? "bg-[#dcfce7] text-[#166534]" : "bg-[#dbeafe] text-[#1e40af]"}`,
  contactDetails:
    "flex flex-col sm:flex-row gap-2 sm:gap-6 sm:flex-wrap mt-2 sm:mt-0",
  detailItem:
    "flex items-center gap-[0.4rem] text-[0.85rem] text-text-muted break-all sm:break-normal",
  messageBox:
    "bg-[#f8fafc] p-4 sm:py-5 sm:px-6 rounded-2xl text-[0.95rem] leading-[1.6] text-[#334155] border border-[#f1f5f9]",
};
...
export const adminDashboardStyles = {
  ...
  statIconContainer:
    "w-11 h-11 rounded-[0.875rem] flex items-center justify-center",
  ...
  adminToolButton:
    "btn bg-white/20 text-white w-full justify-start text-[0.875rem]",
};
...
export const adminInquiriesStyles = {
  ...
  cardTopSection:
    "flex flex-col sm:flex-row justify-between items-start mb-6 border-b border-[#f1f5f9] pb-6 gap-4 sm:gap-4",
  ...
  dateWrapper:
    "text-sm text-text-muted text-left sm:text-right w-full sm:w-auto",
  ...
  detailLabel:
    "text-xs font-bold text-text-muted uppercase mb-3 tracking-widest",
...
export const adminUsersStyles = {
  ...
  filterButton:
    "flex items-center gap-2 px-4 py-2.5 rounded-lg border border-[#e2e8f0] bg-white text-text-main shadow-sm hover:bg-[#f8fafc] transition-all duration-200 cursor-pointer",
  filterDropdown:
    "absolute right-0 max-sm:left-0 max-sm:right-auto mt-2 w-44 rounded-xl border border-[#e2e8f0] bg-white shadow-lg z-20 overflow-hidden",
  filterOption: (isActive) =>
    `w-full text-left px-4 py-2.5 hover:bg-[#f8fafc] ${isActive ? "font-semibold text-primary" : "text-text-main"}`,
  ...
  thead:
    "bg-[#f8fafc] text-[#64748b] text-[0.7rem] font-bold uppercase tracking-[0.05em]",
  ...
  userAvatar:
    "w-10 h-10 rounded-full bg-primary-light text-primary flex items-center justify-center font-bold",
  ...
  statusBadgeBlocked:
    "text-[#dc2626] text-[0.8125rem] font-bold inline-flex items-center gap-1.5 justify-center bg-[#fff5f5] py-1 px-2 rounded-lg border border-[#fee2e2]",
  statusBadgeActive:
    "text-[#10b981] text-[0.8125rem] font-bold inline-flex items-center gap-1.5 justify-center bg-[#f0fdf4] py-1 px-2 rounded-lg border border-[#dcfce7]",
  tdActions: "py-6 px-6 text-right",
  actionsWrapper: "flex gap-2 justify-end",
  blockButton: (isBlocked) =>
    `w-9 h-9 rounded-lg border border-[#e2e8f0] bg-white flex items-center justify-center cursor-pointer hover:bg-gray-50 ${isBlocked ? "text-[#10b981]" : "text-[#f59e0b]"}`,
  deleteButton:
    "w-9 h-9 rounded-lg border-none bg-[#fef2f2] text-[#dc2626] flex items-center justify-center cursor-pointer hover:bg-red-100",
...
export const myInquiriesStyles = {
  ...
  containerFadeIn:
    "container fade-in w-full max-w-full px-4 sm:px-6 lg:px-8 overflow-hidden",
  py12Pt12: "py-12 pt-12",
  pt0: "pt-0",
  mb12: "mb-8 md:mb-12",
  heading: "text-[2rem] md:text-[2.5rem] mb-2 font-extrabold",
  textMuted: "text-text-muted text-sm md:text-base",
  cardPremiumPy24Px8TextCenter:
    "card-premium py-16 px-6 md:py-24 md:px-8 text-center",
  iconContainer:
    "bg-[#f8fafc] w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mx-auto mb-6 text-[#94a3b8]",
  ...
  inquiryCard:
    "card-premium p-5 md:p-6 lg:p-8 flex flex-col lg:flex-row justify-between items-start lg:items-stretch gap-6 overflow-hidden",
  inquiryMain: "flex flex-col sm:flex-row gap-4 md:gap-6 flex-1 w-full min-w-0",
  iconWrapper:
    "bg-primary-light p-3 md:p-4 rounded-xl text-primary h-fit shrink-0",
  iconSize: "w-5 h-5 md:w-6 md:h-6",
  flex1: "flex-1 min-w-0 w-full",
  titleRow:
    "flex items-start md:items-center justify-between md:justify-start gap-3 mb-3 flex-wrap",
  titleText:
    "text-[1.1rem] md:text-[1.25rem] font-bold text-text-main break-words",
  badge: "badge shrink-0 px-2 py-1 text-xs whitespace-nowrap",
  badgeRead: "bg-[#f1f5f9] text-[#64748b]",
  badgeNew: "bg-[#eff6ff] text-[#2563eb]",
  buyerInfo:
    "flex flex-col md:flex-row gap-3 md:gap-6 mb-5 p-3 md:p-4 bg-[#f8fafc] rounded-xl flex-wrap w-full",
  infoItem:
    "flex items-center gap-2 text-[0.85rem] md:text-sm text-[#475569] break-all sm:break-normal min-w-0",
  textMutedSmall: "text-[#94a3b8] shrink-0",
  fontSemibold: "font-semibold text-text-main",
  message:
    "text-[#334155] text-[0.95rem] md:text-base italic mb-5 pl-3 border-l-[3px] border-[#e2e8f0] break-words",
  ...
  actions:
    "flex flex-col sm:flex-row lg:flex-col gap-3 w-full lg:w-[160px] lg:shrink-0 lg:ml-6 pt-4 lg:pt-0 border-t border-[#f1f5f9] lg:border-t-0 justify-center",
  btnOutline:
    "btn btn-outline py-2.5 px-4 md:py-3 w-full justify-center flex items-center gap-2 text-sm",
  btnPrimaryWhitespaceNowrap:
    "btn btn-primary py-2.5 px-4 md:py-3 w-full justify-center text-sm",
  btnMessage:
    "btn py-2.5 px-4 md:py-3 w-full justify-center bg-[#2563eb] text-white hover:bg-[#1d4ed8] flex items-center gap-2 text-sm rounded-xl font-semibold shadow-sm",
};
...
export const sellerRequestsStyles = {
  ...
  // Request grid & card
  requestGrid:
    "grid grid-cols-[repeat(auto-fill,minmax(350px,1fr))] gap-6 max-sm:grid-cols-1",
  requestCard:
    "border border-[#f1f5f9] rounded-2xl p-6 bg-[#f8fafc] transition-all duration-300 ease-in-out hover:-translate-y-1",
  requestHeader: "flex items-center gap-4 mb-5",
  avatar:
    "w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold text-[1.25rem]",
  ...
  // Button
  approveButton:
    "w-full p-3 rounded-xl border-none bg-primary text-white font-bold cursor-pointer flex items-center justify-center gap-2 transition-transform duration-200 ease-in-out hover:-translate-y-[2px]",
};
...
export const wishlistStyles = {
  ...
  emptyIconWrapper:
    "bg-bg-alt w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-8 text-text-muted",
  emptyTitle: "mb-4",
  emptyText: "text-text-muted mb-8",
  browseButton: "btn btn-primary",
  gridContainer:
    "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:justify-items-center",
  removeButton:
    "btn w-full p-3 rounded-xl bg-[#fff5f5] text-[#ef4444] border border-[#fee2e2] flex items-center justify-center gap-2 font-bold",
};
...
export const addPropertyStyles = {
  ...
  heading:
    "text-[clamp(1.75rem,5vw,2.5rem)] mb-4 text-text-main font-extrabold",
  ...
  // Inputs
  input:
    "w-full py-3.5 px-4 rounded-xl border border-[#e2e8f0] outline-none bg-white text-[0.9375rem] focus:border-primary transition-colors",
  textarea: "h-[120px] resize-none leading-relaxed",
  select: "cursor-pointer",

  // Grid layouts
  twoColumnGrid:
    "grid grid-cols-1 md:grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-8 mb-12",
  ...
  amenityLabelBase:
    "flex items-center gap-3 cursor-pointer p-3 rounded-xl border transition-all duration-200",
  ...
  // Image upload
  uploadArea:
    "border-2 border-dashed border-[#cbd5e1] p-12 rounded-xl text-center cursor-pointer relative bg-[#f8fafc] transition-colors hover:border-primary",
  ...
  // Previews
  previewsGrid:
    "grid grid-cols-[repeat(auto-fill,minmax(100px,1fr))] gap-4 mt-8",
  previewItem:
    "relative aspect-square rounded-xl overflow-hidden border border-[#f1f5f9] shadow-sm",
  removeButton:
    "absolute top-1 right-1 bg-[#dc2626] text-white border-none rounded-full w-5 h-5 flex items-center justify-center cursor-pointer z-10 shadow-md",
  addMoreBox:
    "aspect-square border-2 border-dashed border-[#cbd5e1] rounded-xl flex flex-col items-center justify-center cursor-pointer relative bg-[#f8fafc] transition-colors hover:border-primary",
  addMoreText: "text-xs font-bold text-[#64748b] mt-1.5",

  // Footer buttons
  footerButtons:
    "mt-12 flex justify-center flex-wrap gap-5 border-t border-[#f1f5f9] pt-10",
...
export const editPropertyStyles = {
  ...
  input:
    "w-full py-3.5 px-4 rounded-xl border border-[#e2e8f0] outline-none bg-white text-[0.9375rem] focus:border-primary transition-colors",
  textarea:
    "w-full h-[120px] py-3.5 px-4 rounded-xl border border-[#e2e8f0] outline-none resize-none bg-white text-[0.9375rem] leading-relaxed focus:border-primary transition-colors",
  select:
    "w-full p-3.5 rounded-xl border border-[#e2e8f0] outline-none bg-white cursor-pointer focus:border-primary transition-colors",
  twoColumnGrid:
    "grid grid-cols-1 md:grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-8 mb-12",
  threeColumnGrid: "grid grid-cols-1 sm:grid-cols-3 gap-4",
  twoColumnGridInner: "grid grid-cols-1 sm:grid-cols-2 gap-4",
  amenitiesGrid: "grid grid-cols-[repeat(auto-fill,minmax(150px,1fr))] gap-4",
  amenityLabel: (isSelected) =>
    `flex items-center gap-3 cursor-pointer p-3 rounded-xl border transition-all duration-200 ${isSelected ? "bg-primary-light border-primary" : "bg-[#f8fafc] border-[#e2e8f0]"}`,
  amenityCheckbox: "accent-primary w-4 h-4",
  amenityText: (isSelected) =>
    `text-sm font-semibold ${isSelected ? "text-primary" : "text-text-main"}`,
  imageGrid: "grid grid-cols-[repeat(auto-fill,minmax(100px,1fr))] gap-4",
  imageCard:
    "relative aspect-square rounded-xl overflow-hidden border-2 border-[#f1f5f9]",
  imageCardNew:
    "relative aspect-square rounded-xl overflow-hidden border-2 border-dashed border-primary",
  imageCardImg: "w-full h-full object-cover",
  removeImageBtn:
    "absolute top-1 right-1 bg-[#dc2626] text-white border-none rounded-full w-5 h-5 flex items-center justify-center cursor-pointer z-10",
  imageBadgeExisting:
    "absolute bottom-0 left-0 right-0 bg-primary text-white text-[0.6rem] text-center py-0.5 font-bold tracking-widest",
  imageBadgeNew:
    "absolute bottom-0 left-0 right-0 bg-[#10b981] text-white text-[0.6rem] text-center py-0.5 font-bold tracking-widest",
  uploadCard:
    "aspect-square border-2 border-dashed border-[#cbd5e1] rounded-xl flex flex-col items-center justify-center cursor-pointer relative bg-[#f8fafc] transition-colors hover:border-primary",
...
export const myPropertiesStyles = {
  ...
  // Header section
  header:
    "flex flex-col md:flex-row justify-between items-start md:items-center mb-8 flex-wrap gap-6 my-props-header text-left",
  heading: "text-[1.75rem] font-extrabold text-text-main mb-1",
  subheading: "text-text-muted text-[0.9375rem]",
  addButton:
    "btn btn-primary py-3 px-6 rounded-xl font-bold w-full md:w-auto text-center",
  ...
  emptyCard: "card-premium py-24 px-8 text-center",
  emptyIconWrapper:
    "bg-[#f8fafc] w-[80px] h-[80px] rounded-full flex items-center justify-center mx-auto mb-8",
  ...
  select:
    "w-full py-2.5 pr-8 pl-3 text-[0.8125rem] font-semibold rounded-lg border border-[#e2e8f0] bg-white appearance-none cursor-pointer outline-none",
  selectAvailable: "text-[#10b981]",
  selectSold: "text-[#ef4444]",
  selectIcon:
    "absolute right-[0.8rem] top-1/2 -translate-y-1/2 pointer-events-none text-[#94a3b8]",
  editButton:
    "btn btn-outline p-2.5 text-[0.8125rem] flex items-center justify-center gap-1.5 border border-[#e2e8f0]",
  deleteButton:
    "btn p-2.5 text-[0.8125rem] bg-[#fff5f5] text-[#ef4444] border border-[#fee2e2] flex items-center justify-center gap-1.5 transition-colors hover:bg-[#fee2e2]",
};

export const pendingApprovalStyles = {
  // Container
  container:
    "flex flex-col items-center justify-center min-h-[70vh] text-center p-8",

  // Icon circle
  iconCircle:
    "w-[100px] h-[100px] rounded-full bg-[#fef3c7] text-[#d97706] flex items-center justify-center mb-8 shadow-[0_8px_16px_rgba(217,119,6,0.1)] animate-pulse",

  // Heading and text
  heading: "text-[2rem] font-extrabold text-[#1e293b] mb-4",
  description:
    "max-w-[500px] text-[#64748b] text-[1.1rem] leading-relaxed mb-10",
  ...
  // Browse button
  browseButton:
    "py-3.5 px-6 rounded-xl bg-primary text-white font-bold no-underline flex items-center gap-2 shadow-[0_4px_12px_rgba(var(--primary-rgb),0.2)] transition-all duration-300",

  // Manual refresh button
  refreshButtonBase:
    "py-3.5 px-6 rounded-xl bg-[#eef2ff] border border-[#e0e7ff] text-primary font-bold flex items-center gap-2 transition-all duration-300",
  refreshButtonEnabled: "cursor-pointer",
  refreshButtonDisabled: "cursor-not-allowed",

  // Support section
  supportContainer:
    "mt-16 flex items-center gap-2 text-[#94a3b8] text-[0.9rem]",
  supportLink: "text-primary no-underline font-semibold",
};

export const sellerDashboardStyles = {
  header:
    "flex flex-col md:flex-row justify-between items-start mb-8 flex-wrap gap-6 md:gap-6",
  headerLeft: "min-w-0 w-full md:w-auto md:min-w-[280px]",
  headerTitle:
    "text-[1.5rem] sm:text-[1.75rem] font-extrabold text-text-main mb-1",
  headerSubtitle: "text-[#64748b] text-[0.9375rem]",
  headerActions: "flex gap-3 flex-wrap w-full md:w-auto",
  exportButton:
    "btn btn-outline bg-white flex items-center gap-2 font-bold flex-1 justify-center whitespace-nowrap",
  addButton:
    "btn btn-primary flex items-center gap-2 font-bold py-3 px-5 flex-1 justify-center whitespace-nowrap",
  statsGrid:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-[repeat(auto-fit,minmax(240px,1fr))] gap-4 sm:gap-5 mb-12",
  statCard:
    "bg-white p-6 rounded-[1.25rem] border border-[#f1f5f9] shadow-[0_4px_20px_rgba(0,0,0,0.02)]",
  statIconWrapper:
    "w-10 h-10 rounded-xl bg-[#f1f5f9] flex items-center justify-center mb-5",
  ...
  searchInput:
    "py-2.5 pr-4 pl-10 rounded-xl border border-[#e2e8f0] outline-none text-[0.875rem] w-full",
  emptyListings: "card-premium py-16 text-center text-[#64748b]",
  propertiesGrid:
    "grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-6 justify-items-center max-sm:grid-cols-1 max-sm:px-4",
  propertyActions: "flex-1 flex gap-[0.4rem]",
  statusButton: (status) =>
    `btn btn-outline flex-1 p-2 text-[0.75rem] flex items-center justify-center gap-1 ${status === "sold" ? "text-primary border-primary hover:bg-primary-light" : "text-[#64748b]"}`,
  editButton:
    "btn btn-outline flex-1 p-2 text-[0.75rem] flex items-center justify-center gap-1",
  deleteButton:
    "btn btn-outline flex-1 p-2 text-[0.75rem] text-[#ef4444] border-[#fee2e2] flex items-center justify-center gap-1 hover:bg-red-50",
  viewButton: "btn btn-primary p-2 flex items-center justify-center",
  showMoreWrapper: "text-center mt-10",
  showMoreButton:
    "btn btn-outline py-3 px-10 font-extrabold text-[0.9rem] rounded-xl bg-white shadow-[0_4px_12px_rgba(0,0,0,0.05)] inline-flex items-center gap-2",
  widgetsGrid: "grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-8 mb-8",
  inquiriesWidget:
    "bg-white rounded-3xl border border-[#f1f5f9] p-6 shadow-[0_4px_20px_rgba(0,0,0,0.02)]",
  ...
  inquiryIcon:
    "w-10 h-10 rounded-full bg-[#f1f5f9] flex items-center justify-center border-2 border-white shadow-[0_2px_10px_rgba(0,0,0,0.05)]",
  ...
  inquiryStatus: (status) =>
    `py-0.5 px-2 rounded-full text-[0.65rem] font-extrabold uppercase ${status === "read" ? "bg-[#f1f5f9] text-[#64748b]" : "bg-primary-light text-primary"}`,
  ...
  tipTitleHighViews:
    "text-primary mb-1 flex items-center gap-2 text-[0.875rem]",
...
export const chatMessagesStyles = {
  ...
  // Chat wrapper
  chatWrapper:
    "flex flex-1 bg-[#f8fafc] font-sans relative overflow-hidden mt-0 md:mt-0",

  // Sidebar
  sidebar:
    "w-full absolute inset-0 z-10 transition-transform duration-300 lg:relative lg:w-[350px] shrink-0 bg-white border-r border-[#e2e8f0] flex flex-col lg:translate-x-0",
  ...
  emptyConversations:
    "flex-1 flex flex-col items-center justify-center text-[#94a3b8] text-center p-10",
  emptyIcon: "w-20 h-20 mb-5 opacity-50",
  conversationItem:
    "p-[15px_20px] flex items-center gap-3 cursor-pointer transition-colors duration-200 border-b border-[#f8fafc] hover:bg-[#f1f5f9] group",
  conversationItemActive: "bg-[#f0f9ff] border-r-[3px] border-r-[#00b4d8]",
  avatar:
    "w-9 h-9 md:w-12 md:h-12 rounded-full bg-[#00b4d8] text-white flex items-center justify-center font-bold text-[0.9rem] md:text-base overflow-hidden",
  avatarImg: "w-full h-full object-cover",
  conversationInfo: "flex-1 min-w-0",
  conversationName:
    "font-semibold text-[#1e293b] mb-1 whitespace-nowrap overflow-hidden text-ellipsis",
  conversationPreview:
    "text-[0.85rem] text-[#64748b] whitespace-nowrap overflow-hidden text-ellipsis",
  deleteChatButton:
    "bg-transparent border-none text-[#94a3b8] p-2 rounded-lg cursor-pointer opacity-100 md:opacity-0 transition-all duration-200 flex items-center justify-center hover:text-red-500 hover:bg-red-100 md:group-hover:opacity-100",

  // Chat area
  chatArea:
    "absolute inset-0 z-[5] lg:relative lg:flex-1 lg:z-auto flex flex-col bg-white w-full",
  chatHeader:
    "p-[10px_15px] md:p-[15px_25px] bg-white sticky md:relative top-0 z-20 border-b border-[#e2e8f0] flex items-center justify-between",
  chatHeaderLeft: "flex items-center gap-3",
  backButton:
    "flex lg:hidden mr-2.5 bg-[#f1f5f9] border-none p-1.5 rounded-full text-[#1e293b]",
  chatPartnerName: "font-bold text-[#1e293b]",
  messagesArea:
    "p-[15px] pb-[80px] md:p-[25px] md:pb-[25px] overflow-y-auto flex-1 flex flex-col gap-[15px] bg-[#f8fafc]",
  messageBubble:
    "max-w-[85%] md:max-w-[70%] p-[12px_18px] rounded-[20px] text-[0.95rem] leading-[1.5] relative",
  messageOwn:
  ...
  deleteMessageButton:
    "bg-transparent border-none text-white/60 cursor-pointer p-0.5 rounded transition-all duration-200 mt-0.5 hover:text-white hover:bg-white/20",
  messageTime: "text-[0.75rem] mt-1.5 opacity-70 block",
  messageForm:
    "p-[12px_15px] md:p-[20px_25px] bg-white sticky md:relative bottom-0 border-t border-[#e2e8f0] flex gap-[15px] items-center",
  messageInput:
    "flex-1 min-w-0 border border-[#e2e8f0] rounded-[30px] p-[12px_25px] outline-none text-[0.95rem] transition-colors duration-200 focus:border-[#00b4d8]",
  sendButton:
    "bg-[#00b4d8] text-white border-none w-[45px] h-[45px] rounded-full cursor-pointer flex items-center justify-center transition-all duration-200 text-xl hover:bg-[#0077b6] hover:scale-105 active:scale-95 shrink-0",
  sendIcon: "rotate-90",
  noChatSelected:
    "flex-1 flex flex-col items-center justify-center text-[#94a3b8] text-center p-10",
...
export const contactStyles = {
  ...
  contactIconWrapper:
    "w-10 h-10 rounded-xl bg-primary-light text-primary flex items-center justify-center",
  contactIconWrapperAlt:
    "w-10 h-10 rounded-xl bg-[#dbeafe] text-[#1e40af] flex items-center justify-center",
  contactTitle: "font-bold text-base",
  contactDetail: "text-text-muted text-[0.9rem]",

  // Quick support card
  quickSupportCard:
    "card-premium h-[200px] bg-primary text-white flex flex-col justify-center items-center p-8 text-center",
  ...
  input:
    "w-full p-3 rounded-xl border border-[#e2e8f0] outline-none transition-colors focus:border-primary",
  textarea: "resize-none",
  errorMessage: "text-red-600 text-[0.875rem] p-3 bg-red-50 rounded-lg",
  submitButton:
    "btn btn-primary w-full p-4 rounded-xl font-bold text-base mt-4",
};

export const profileStyles = {
  containerWrapper: (role) =>
    role !== "seller"
      ? "bg-bg-alt min-h-screen pt-32 max-lg:pt-28"
      : "bg-transparent min-h-auto",
  mainContainer: (role) =>
    `container fade-in max-w-[800px] mb-16 ${role !== "seller" ? "mx-auto pt-12" : "mx-0 pt-0"}`,
  header: "mb-12 md:text-center md:mb-8",
  pageTitle: "text-[2.5rem] mb-2 md:text-[2rem]",
  pageSubtitle: "text-text-muted",
  card: "card-premium p-12 md:p-6",
  profileHeader:
    "flex flex-col md:flex-row items-center gap-4 md:gap-8 mb-10 md:mb-16 text-center md:text-left",
  avatarSection: "relative",
  avatarWrapper:
    "w-[120px] h-[120px] rounded-[2.5rem] bg-primary-light overflow-hidden flex items-center justify-center text-[3rem] font-bold text-primary border-4 border-white shadow-lg",
  avatarImage: "w-full h-full object-cover",
  avatarPlaceholder: "text-primary opacity-60",
  uploadButton:
    "absolute -bottom-2.5 -right-2.5 bg-primary text-white w-10 h-10 rounded-full flex items-center justify-center cursor-pointer shadow-[0_4px_10px_rgba(0,0,0,0.2)] border-4 border-white z-10 hover:bg-primary-dark transition-colors",
  removeButton:
    "absolute -top-2.5 -right-2.5 bg-red-500 text-white w-10 h-10 rounded-full flex items-center justify-center cursor-pointer shadow-[0_4px_10px_rgba(0,0,0,0.2)] border-4 border-white z-10 hover:bg-red-600 transition-colors",
  userName: "text-[1.75rem] mb-1 break-all sm:break-normal",
  roleBadge:
    "badge badge-sale bg-primary-light text-primary px-4 py-2 rounded-xl",
  ...
  input:
    "w-full p-3.5 rounded-xl border border-border outline-none focus:border-primary transition-colors",
  textarea:
    "w-full h-[100px] p-3.5 rounded-xl border border-border outline-none resize-none focus:border-primary transition-colors",
  ...
  infoIcon:
    "w-12 h-12 rounded-2xl bg-[#f8fafc] flex items-center justify-center text-primary shrink-0",
...
export const propertiesStyles = {
  ...
  resetButton:
    "bg-transparent border-none text-primary text-sm font-semibold cursor-pointer",
  closeMobileFilters:
    "mobile-close-filters hidden max-[1024px]:flex items-center justify-center bg-[#f1f5f9] border-none p-2 rounded-full cursor-pointer",
  ...
  searchIcon: "absolute left-4 top-1/2 -translate-y-1/2 text-[#94a3b8]",
  searchInput:
    "w-full py-3 pr-4 pl-10 rounded-xl border border-[#e2e8f0] outline-none text-sm",
  ...
  checkboxLabel:
    "flex items-center gap-3 cursor-pointer text-sm text-[#64748b]",
  checkbox: "w-[18px] h-[18px] cursor-pointer accent-primary",
  bhkGroup: "flex flex-wrap gap-2",
  bhkButton:
    "flex-1 min-w-[50px] p-2 rounded-lg text-sm font-bold cursor-pointer transition-all duration-200 border border-[#e2e8f0] bg-white text-[#64748b]",
  ...
  contentHeader:
    "content-header bg-white py-5 px-8 rounded-[1.25rem] mb-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex justify-between items-center border border-[#f1f5f9] max-[1024px]:p-4 max-[1024px]:flex-col max-[1024px]:gap-4 max-[1024px]:items-start",
  resultCount: "text-[#64748b] text-[0.9375rem]",
  resultCountStrong: "text-text-main",
  headerControls:
    "view-controls flex items-center gap-6 max-[1024px]:w-full max-[1024px]:justify-between",
  viewModeToggle:
    "view-mode-toggle flex gap-2 p-1 bg-[#f1f5f9] rounded-xl max-sm:hidden",
  ...
  sortSelect:
    "py-2 px-4 bg-white border border-[#e2e8f0] rounded-xl text-sm font-semibold cursor-pointer outline-none text-text-main appearance-auto",
  ...
  // Empty state
  emptyContainer:
    "py-24 px-8 text-center bg-white rounded-[1.5rem] border border-[#f1f5f9]",
  emptyIconWrapper:
    "w-[80px] h-[80px] bg-[#f1f5f9] rounded-full flex items-center justify-center mx-auto mb-6",
  ...
  propertyListGrid:
    "grid-cols-[repeat(auto-fill,minmax(280px,1fr))] max-sm:grid-cols-1 max-sm:justify-items-center",
...
export const propertyDetailsStyles = {
  ...
  galleryMainItem: (hasMultiple) =>
    `gallery-item main-image relative overflow-hidden bg-[#f1f5f9] cursor-pointer ${hasMultiple ? "col-span-2 row-span-2" : "col-span-1 row-span-1"}`,
  gallerySideItem:
  ...
  mobileSliderTrack:
    "mobile-slider flex overflow-x-auto snap-x snap-mandatory scroll-smooth p-0 whitespace-nowrap [&::-webkit-scrollbar]:hidden",
  mobileSlide:
    "mobile-slide flex-[0_0_100%] snap-start relative aspect-[4/3] overflow-hidden",
  ...
  lightboxNextBtn:
    "absolute -right-[22px] top-1/2 -translate-y-1/2 bg-white border-none text-primary w-11 h-11 flex items-center justify-center cursor-pointer rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.12)] transition-all duration-200 hover:bg-white/20 hover:scale-110",
  lightboxCounter:
    "absolute -bottom-[45px] left-1/2 -translate-x-1/2 text-white text-base font-semibold drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]",
  detailsLayout:
    "details-layout grid grid-cols-[1fr_380px] gap-10 items-start max-[1024px]:grid-cols-1 max-[1024px]:gap-8",
  ...
  descriptionText:
    "text-[#475569] text-base leading-relaxed break-words whitespace-pre-wrap",
  amenitiesSection: "mb-10 min-w-0",
  amenitiesGrid:
    "amenities-grid grid grid-cols-[repeat(auto-fill,minmax(180px,1fr))] gap-4",
  amenityItem:
    "flex items-start gap-3 text-[#334155] font-medium text-[0.9375rem] min-w-0",
  amenityIcon: "text-primary shrink-0 mt-0.5",
  amenityText: "break-words whitespace-normal",
  sidebarColumn: "sidebar-column min-w-0",
  priceCard:
    "text-white p-6 rounded-[1.5rem] mb-6 shadow-[0_10px_25px_rgba(13,148,136,0.2)]",
  priceCardLabel: "text-[0.875rem] opacity-80 font-semibold uppercase mb-2",
  priceCardValue:
    "text-[2.25rem] font-extrabold my-1 break-words whitespace-normal leading-tight",
  ...
  priceCardAvailability:
    "text-[0.8125rem] opacity-90 break-words whitespace-normal",
  sellerCard:
    "bg-white p-6 rounded-[1.5rem] border border-[#f1f5f9] shadow-[0_4px_20px_rgba(0,0,0,0.03)] min-w-0",
  ...
  chatButton:
    "btn btn-outline flex-1 p-2.5 text-[0.875rem] flex items-center justify-center gap-2",
  inquiryFormTitle: "text-[0.9375rem] font-bold mb-4",
  inquiryTextarea:
    "w-full h-[100px] p-3 rounded-xl border border-[#e2e8f0] mb-4 outline-none resize-none text-[0.875rem] break-words whitespace-pre-wrap",
  ...
  inquiryDisabledText:
    "text-[0.875rem] text-[#64748b] break-words whitespace-normal",
  inquiryLoginButton: "btn btn-primary mt-2 w-full block",
  additionalDetails:
    "additional-details bg-white p-8 rounded-[1.5rem] border border-[#f1f5f9] mt-12 min-w-0",
  ...
  similarAllLink:
    "btn btn-outline flex items-center gap-2 py-2.5 px-5 text-[0.875rem]",
  similarGrid:
    "similar-grid grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-6",
  similarEmptyState:
    "col-span-full p-12 bg-[#f8fafc] rounded-[1.5rem] text-center border border-dashed border-[#e2e8f0] text-[#64748b] break-words whitespace-normal",
};
...
export const sellerProfileStyles = {
  ...
  // Profile header card
  profileCard:
    "bg-white rounded-3xl p-6 sm:p-10 shadow-[0_10px_30px_rgba(0,0,0,0.04)] border border-[#f1f5f9] mb-12 flex flex-wrap gap-10 items-center justify-center sm:justify-start text-center sm:text-left",
  avatarWrapper:
    "w-[150px] h-[150px] rounded-full overflow-hidden border-4 border-[#f1f5f9]",
  avatarImage: "w-full h-full object-cover",
  profileInfo: "flex-1 min-w-[300px]",
  nameBadgeWrapper:
    "flex items-center justify-center sm:justify-start gap-3 mb-2",
  sellerName: "text-4xl font-extrabold text-text-main m-0",
  verifiedBadge: "text-primary",
  statsWrapper:
    "flex flex-wrap justify-center sm:justify-start gap-6 mb-6 text-[#64748b]",
  ...
  propertiesGrid:
    "grid grid-cols-1 sm:grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-6",
  emptyProperties:
    "col-span-full p-12 bg-[#f8fafc] rounded-3xl text-center border border-[#e2e8f0]",
};
...
export const forgotPasswordStyles = {
  ...
  formCard:
    "glass fade-in w-full max-w-[450px] p-10 sm:p-6 rounded-3xl sm:rounded-2xl shadow-card",
...
export const registerStyles = {
  ...
  roleLabelBase:
    "flex-1 cursor-pointer p-3 rounded-lg border-2 text-center transition-all duration-200",
...
export const verifyEmailStyles = {
  ...
  input:
    "w-full py-3 px-4 rounded-lg border border-border outline-none focus:border-primary transition-colors",
  codeInput:
    "w-full py-3 px-4 rounded-lg border border-border outline-none focus:border-primary transition-colors text-center text-2xl tracking-[0.5em]",
  submitButton: "btn btn-primary p-3.5 text-base mt-2",
};
...
export const adminLayoutStyles = {
  ...
  mainWrapper:
    "flex-1 flex flex-col min-w-0 h-full overflow-hidden transition-all duration-300 md:ml-[260px]",
  mainContent:
    "flex-1 overflow-y-auto p-5 md:p-8 relative scroll-smooth fade-in",
};

export const adminSidebarStyles = {
  backdrop: (isOpen) =>
    `fixed inset-0 w-full h-full bg-black/30 backdrop-blur-sm z-[950] transition-all duration-300 ${
      isOpen ? "opacity-100 visible" : "opacity-0 invisible hidden md:block"
    }`,
  sidebar: (isOpen) =>
...
export const dashboardNavbarStyles = {
  header:
    "h-[64px] bg-white/70 backdrop-blur-[12px] border-b border-white/20 flex items-center px-4 sticky top-0 z-[900] w-full gap-4 md:hidden",
  menuButton:
    "bg-primary/5 border-none text-primary cursor-pointer flex items-center justify-center w-10 h-10 rounded-xl shrink-0",
...
export const reviewSectionStyles = {
  ...
  starButton:
    "bg-transparent border-none cursor-pointer p-0 transition-colors duration-100",
  starActive: "text-[#eab308]",
  starInactive: "text-[#cbd5e1] hover:text-[#eab308]",
  reviewTextarea:
    "w-full min-h-[120px] p-4 rounded-xl border border-border mb-4 font-inherit resize-y",
  ...
  reviewCard:
    "p-6 rounded-2xl bg-white border border-border shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05)]",
...
export const logoStyles = {
  ...
  iconWrapper:
    "bg-primary text-white p-2 rounded-[10px] flex items-center justify-center shadow-[0_4px_12px_rgba(13,110,89,0.2)]",
...
export const navbarStyles = {
  ...
  desktopMenu:
    "hidden lg:flex justify-self-center items-center bg-white/50 px-3 py-1.5 rounded-full border border-white/30 gap-2 shadow-[0_4px_15px_rgba(0,0,0,0.05)]",
  navLink:
    "nav-link text-text-main font-semibold text-[15px] px-4 py-2 rounded-3xl transition-all duration-300 no-underline hover:text-primary hover:bg-primary/10",
  ...
  logoutButton:
    "btn btn-outline hidden lg:flex py-1.5 px-4 rounded-xl font-semibold text-sm",
  mobileToggle: "lg:hidden cursor-pointer text-text-main flex",
  backdrop: (isOpen) =>
    `fixed inset-0 w-full h-full bg-black/40 backdrop-blur-sm z-[2001] transition-all duration-300 ${isOpen ? "opacity-100 visible" : "opacity-0 invisible"}`,
  drawer: (isOpen) =>
    `fixed top-0 -left-[300px] w-[300px] h-full bg-white z-[2002] transition-transform duration-300 shadow-[10px_0_30px_rgba(0,0,0,0.1)] border-r border-border flex flex-col p-6 ${isOpen ? "translate-x-[300px]" : ""}`,
...
export const propertyCardStyles = {
  ...
  badgeStatus: (status) =>
    `text-white px-3 py-1 rounded-full text-xs font-extrabold uppercase backdrop-blur shadow-[0_2px_8px_rgba(0,0,0,0.1)] ${status === "sold" ? "bg-[#64748b]" : "bg-[#10b981]"}`,
  badgeNew:
  ...
  priceOverlay:
    "absolute bottom-0 left-0 right-0 pt-6 pb-3 px-4 bg-gradient-to-t from-black/70 to-transparent text-white",
  price: "text-[1.5rem] font-extrabold m-0",

  // Content section
  content: "p-5 flex flex-col flex-1",
  propertyType:
    "text-[0.75rem] font-bold text-primary uppercase tracking-[0.05em]",
  views:
    "flex items-center gap-[0.3rem] color-[#64748b] text-[0.8125rem] font-semibold",
  title:
    "text-[1.125rem] font-bold mt-1 mb-2 text-text-main whitespace-nowrap overflow-hidden text-ellipsis min-h-[1.5rem]",
  location:
    "flex items-center gap-[0.4rem] text-text-muted text-[0.875rem] mb-4",
  locationIcon: "text-[#94a3b8] shrink-0",
  specsGrid:
    "grid grid-cols-[1fr_1fr_1fr] py-4 border-t border-[#f1f5f9] gap-2 mt-auto",
  ...
  viewDetailsBtn:
    "btn btn-primary w-full p-3 rounded-xl font-bold text-[0.9375rem]",
